...
class MSFS2024_Vegetation(MSFS2024_Material):
    ...
    def draw_panel(layout, material):
        MSFS2024_Vegetation.draw_parameters_panel(layout=layout, material=material)
        MSFS2024_Vegetation.draw_textures_panel(layout=layout, material=material)
    ...
    def draw_textures_panel(layout, material):
        ...
        MSFS2024_MaterialUtilsUI.draw_texture_prop(
            layout=box, 
            material=material, 
            prop=MSFS2024_MaterialProperties.FOLIAGEMASKTEXTURE.attribute_name(),
            text=MSFS2024_MaterialProperties.FOLIAGEMASKTEXTURE.property_name()
        )
