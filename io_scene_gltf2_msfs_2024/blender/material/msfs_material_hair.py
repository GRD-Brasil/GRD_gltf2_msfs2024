...
class MSFS2024_Hair(MSFS2024_Material):
    ...
    def custom_shader_tree(self):
        ...
        MSFS2024_Anisotropic.anisotropic_shader_tree(self)

    @staticmethod
    def draw_panel(layout, material):
        MSFS2024_Hair.draw_parameters_panel(layout=layout, material=material)
        MSFS2024_Hair.draw_textures_panel(layout=layout, material=material)
