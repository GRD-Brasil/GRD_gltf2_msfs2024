...
class MSFS2024_Tire(MSFS2024_Material):
    ...
    def set_default_properties(self, attributes=None):
        ...
        setattr(self.material, MSFS2024_MaterialProperties.ALPHAMODE.attribute_name(), "OPAQUE")
    ...
    def draw_panel(layout, material):
        MSFS2024_Tire.draw_parameters_panel(layout, material)
        MSFS2024_Tire.draw_textures_panel(layout, material)
    ...
    def draw_parameters_panel(layout, material):
        ...
        #region Tire Parameters
        box = layout.box()
        box.label(text="Tire Parameters")

        ## Tire Mud Normal Tiling
        MSFS2024_MaterialUtilsUI.draw_prop(
            layout=box,
            material=material,
            prop=MSFS2024_MaterialProperties.TIREMUDNORMALTILING.attribute_name()
        )
        ...
        MSFS2024_MaterialUtilsUI.draw_prop(
            layout=box,
            material=material,
            prop=MSFS2024_MaterialProperties.TIREMUDANIMSTATE.attribute_name()
        )
        
        ## Tire Dust Anim State
        MSFS2024_MaterialUtilsUI.draw_prop(
            layout=box,
            material=material,
            prop=MSFS2024_MaterialProperties.TIREDUSTANIMSTATE.attribute_name()
        )
        #endregion
    ...
    def draw_textures_panel(layout, material):
        ...
        ## Tire Mud Cutout Texture
        MSFS2024_MaterialUtilsUI.draw_texture_prop(
            layout=box, 
            material=material,
            prop=MSFS2024_MaterialProperties.TIREMUDCUTOUTTEXTURE.attribute_name(),
            text=MSFS2024_MaterialProperties.TIREMUDCUTOUTTEXTURE.property_name()
        )
        ...
        ## Tire Mud Details Mud (R) Dust(G)
        MSFS2024_MaterialUtilsUI.draw_texture_prop(
            layout=box, 
            material=material,
            prop=MSFS2024_MaterialProperties.TIREDETAILSTEXTURE.attribute_name(),
            text=MSFS2024_MaterialProperties.TIREDETAILSTEXTURE.property_name()
        )
        ...
        MSFS2024_MaterialUtilsUI.draw_texture_prop(
            layout=box, 
            material=material,
            prop=MSFS2024_MaterialProperties.TIREMUDNORMALTEXTURE.attribute_name(),
            text=MSFS2024_MaterialProperties.TIREMUDNORMALTEXTURE.property_name()
        )
