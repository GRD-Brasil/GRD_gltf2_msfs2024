...
class MSFS2024_Ghost(MSFS2024_Material):
    ...
    def draw_panel(layout, material):
        MSFS2024_Ghost.draw_parameters_panel(layout=layout, material=material)
        MSFS2024_Ghost.draw_textures_panel(layout=layout, material=material)
    ...
    def draw_parameters_panel(layout, material):
        ...
        MSFS2024_MaterialUtilsUI.draw_prop(
            layout=box,
            material=material,
            prop=MSFS2024_MaterialProperties.GHOSTBIAS.attribute_name()
        )
        ...
        MSFS2024_MaterialUtilsUI.draw_prop(
            layout=box,
            material=material,
            prop=MSFS2024_MaterialProperties.GHOSTPOWER.attribute_name()
        )
        ...
        MSFS2024_MaterialUtilsUI.draw_prop(
            layout=box,
            material=material,
            prop=MSFS2024_MaterialProperties.GHOSTSCALE.attribute_name()
        )
        #endregion
