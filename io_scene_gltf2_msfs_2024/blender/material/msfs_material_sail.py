...
class MSFS2024_Sail(MSFS2024_Material):
    ...
    def draw_panel(layout, material):
        MSFS2024_Sail.draw_parameters_panel(layout=layout, material=material)
        MSFS2024_Sail.draw_textures_panel(layout=layout, material=material)
    ...
    def draw_parameters_panel(layout, material):
        ...
        MSFS2024_MaterialUtilsUI.draw_prop(
            layout=box,
            material=material,
            prop=MSFS2024_MaterialProperties.SAILLIGHTABSORPTION.attribute_name()
        )
        #endregion
