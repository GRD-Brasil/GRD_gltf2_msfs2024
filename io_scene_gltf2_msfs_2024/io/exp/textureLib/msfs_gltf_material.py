...
class GltfMaterial:
    def __init__(self, gltf_material) -> None:
        ...
        self.extensions = self.gltf_material.get("extensions")
        self.pbr_metallic_roughness = self.gltf_material.get("pbrMetallicRoughness")
        self.name = self.gltf_material.get("name")
    ...
    def get_base_color_tex_config(self):
        ...
        texture_config = TextureConfig(base_color_texture.get("index"), bmp_config, self.name)
    ...
    def get_metal_rough_ao_tex_config(self):
        ...
        texture_config = TextureConfig(metallic_roughness_texture.get("index"), bmp_config, self.name)
        return texture_config
    ...
    def get_occlusion_tex_config(self, metal_roughness_texture_index=-1):
        ...
        texture_config = TextureConfig(occlusion_texture_index, bmp_config, self.name)
        return texture_config
    ...
    def get_normal_tex_config(self):
        ...
        texture_config = TextureConfig(normal_texture.get("index"), bmp_config, self.name)
        return texture_config
    ...
    def get_emissive_tex_config(self):
        ...
        texture_config = TextureConfig(emissive_texture.get("index"), bmp_config, self.name)
        return texture_config
    ...
    def get_distance_field_layer_mask_tex_config(self):
        ...
        texture_config = TextureConfig(distance_field_texture.get("index"), bmp_config, self.name)
        return texture_config
    ...
    def get_distance_field_color_tex_config(self):
        ...
        texture_config = TextureConfig(layer_texture.get("index"), bmp_config, self.name)
        return texture_config
    ...
    def get_blend_mask_tex_config(self):
        ...
        texture_config = TextureConfig(blend_mask_texture.get("index"), bmp_config, self.name)
        return texture_config
    ...
    def get_detail_color_tex_config(self, blend_mask_texture_index=-1):
        ...
        texture_config = TextureConfig(detail_color_texture.get("index"), bmp_config, self.name)
        return texture_config
    ...
    def get_detail_normal_tex_config(self, blend_mask_texture_index=-1):
        ...
        texture_config = TextureConfig(detail_normal_texture.get("index"), bmp_config, self.name)
        return texture_config
    ...
    def get_detail_metal_rough_ao_tex_config(self, blend_mask_texture_index=-1):
        ...
        texture_config = TextureConfig(detail_metal_rough_ao_texture.get("index"), bmp_config, self.name)
        return texture_config
    ...
    def get_aniso_direction_roughness_tex_config(self):
        ...
        texture_config = TextureConfig(aniso_direction_roughness_texture.get("index"), bmp_config, self.name)
        return texture_config
    ...
    def get_behind_window_text_config(self):
        ...
        # MTL_BITMAP_ADD_DECAL0
        bmp_config = BitmapConfig(5, "", False)
        texture_config = TextureConfig(behind_window_texture.get("index"), bmp_config, self.name)
        return texture_config
    ...
    def get_wiper_mask_tex_config(self):
        ...
        texture_config = TextureConfig(wiper_mask_texture.get("index"), bmp_config, self.name)
        return texture_config
    ...
    def get_windshield_detail_normal_tex_config(self):
        ...
        texture_config = TextureConfig(windshield_detail_normal_texture.get("index"), bmp_config, self.name)
        return texture_config
    ...
    def get_scratches_normal_tex_config(self):
        ...
        texture_config = TextureConfig(scratches_normal_texture.get("index"), bmp_config, self.name)
        return texture_config
    ...
    def get_windshield_insects_tex_config(self):
        ...
        texture_config = TextureConfig(windshield_insects_texture.get("index"), bmp_config, self.name)
        return texture_config
    ...
    def get_windshield_insects_mask_tex_config(self):
        ...
        texture_config = TextureConfig(windshield_insects_mask_texture.get("index"), bmp_config, self.name)
        return texture_config
    ...
    def get_foliage_mask_tex_config(self):
        ...
        texture_config = TextureConfig(foliage_mask_texture.get("index"), bmp_config, self.name)
        return texture_config
    ...
    def get_extra_occlusion_tex_config(self):
        ...
        texture_config = TextureConfig(extra_occlusion_texture.get("index"), bmp_config, self.name)
        return texture_config
    ...
    def get_clearcoat_color_rough_tex_config(self):
        ...
        texture_config = TextureConfig(clearcoat_color_roughness_texture.get("index"), bmp_config, self.name)
        return texture_config
    ...
    def get_clearcoat_normal_tex_config(self):
        ...
        texture_config = TextureConfig(clearcoat_normal_texture.get("index"), bmp_config, self.name)
        return texture_config
    ...
    def get_dirt_mask_tex_config(self):
        ...
        # MTL_BITMAP_BLENDMASK
        bmp_config = BitmapConfig(2, "", False)
        texture_config = TextureConfig(dirt_mask_texture.get("index"), bmp_config, self.name)
        return texture_config
    ...
    def get_iridescent_tex_config(self):
        ...
        texture_config = TextureConfig(iridescent_thickness_texture.get("index"), bmp_config, self.name)
        return texture_config
    ...
    def get_dirt_tex_config(self):
        ...
        texture_config = TextureConfig(dirt_texture.get("index"), bmp_config, self.name)
        return texture_config
    ...
    def get_dirt_occ_rough_metal_tex_config(self):
        ...
        texture_config = TextureConfig(dirt_occ_rough_metal_texture.get("index"), bmp_config, self.name)
        return texture_config
    ...
    def get_tire_details_tex_config(self):
        ...
        texture_config = TextureConfig(tire_details_texture.get("index"), bmp_config, self.name)
        return texture_config
    ...
    def get_tire_mud_normal_tex_config(self):
        ...
        texture_config = TextureConfig(tire_mud_normal_texture.get("index"), bmp_config, self.name)
        return texture_config
