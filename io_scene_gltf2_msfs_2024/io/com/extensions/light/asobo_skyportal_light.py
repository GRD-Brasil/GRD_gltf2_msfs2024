...
class AsoboSkyPortalLight:
    ...
    extension_name = "ASOBO_sky_portal"
    ...
    def from_extension(vnode, gltf2_node, blender_object):
        ...
        extension = gltf2_node.extensions.get(AsoboSkyPortalLight.extension_name)
        if not extension:
            return

        light = MSFS2024AddLight.create_light_object(msfs_light_type="skyPortalLight")
        ...
        for extension_parameter in AsoboSkyPortalLight.extension_parameters:
    ...
    def export(gltf2_object, blender_object):
        ...
        gltf2_object.extensions[AsoboSkyPortalLight.extension_name] = Extension(
            name=AsoboSkyPortalLight.extension_name,
            extension=extension,
            required=False
        )
