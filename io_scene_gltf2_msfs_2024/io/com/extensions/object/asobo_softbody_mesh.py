...
class AsoboSoftBodyMesh:
    ...
    extension_name = "ASOBO_softbody_mesh"
    ...
    def from_extension(gltf2_node, blender_object):
        ...
        extension = gltf2_node.extensions.get(AsoboSoftBodyMesh.extension_name)
        if not extension:
            return
    ...
    def export(gltf2_object, blender_object):
        ...
        if extension:
            gltf2_object.mesh.extensions[AsoboSoftBodyMesh.extension_name] = Extension(
                name=AsoboSoftBodyMesh.extension_name,
                extension=extension,
                required=False
            )
